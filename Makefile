...
clean:
	rm -rf build tests/test_boot_const tools/test_fs_join tests/test_bmp \
		...
		tests/test_hurt tests/test_weapon tests/test_touch tests/test_mem tests/test_leak \
