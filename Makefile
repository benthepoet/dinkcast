...
tests/test_script: tests/test_script.c src/script.c src/mapscr.c src/le.c src/fs.c
	$(HOSTCC) $(HOST_CFLAGS) -o $@ tests/test_script.c src/script.c src/mapscr.c src/le.c src/fs.c
	./$@
