...
tests/test_player: tests/test_player.c src/player.c src/hurt.c src/hard.c src/pad.c src/ini.c src/ff.c src/le.c src/fs.c src/residency.c src/mapscr.c src/audio.c
...
tests/test_talk: tests/test_talk.c src/talk.c src/edraw.c src/sprite.c src/ini.c src/ff.c src/bmp.c src/player.c src/hurt.c src/hard.c src/pad.c src/mapscr.c src/le.c src/fs.c src/residency.c src/mem.c src/audio.c
...
tests/test_script: tests/test_script.c src/script.c src/dinkc_file.c src/dinkc_lex.c src/dinkc_parse.c src/dinkc_vm.c src/dinkc_var.c src/dinkc_cmd.c src/audio.c src/fade.c src/save.c src/saybox.c src/font.c src/player.c src/hurt.c src/hard.c src/pad.c src/ini.c src/ff.c src/mapscr.c src/world.c src/le.c src/fs.c src/residency.c
	$(HOSTCC) $(HOST_CFLAGS) -o $@ tests/test_script.c src/script.c src/dinkc_file.c src/dinkc_lex.c src/dinkc_parse.c src/dinkc_vm.c src/dinkc_var.c src/dinkc_cmd.c src/audio.c src/fade.c src/save.c src/saybox.c src/font.c src/player.c src/hurt.c src/hard.c src/pad.c src/ini.c src/ff.c src/mapscr.c src/world.c src/le.c src/fs.c src/residency.c
	DINK_DATA="$(DINK_DATA)" ./$@
...
tests/test_dinkc_vm: tests/test_dinkc_vm.c src/dinkc_vm.c src/dinkc_lex.c src/dinkc_var.c src/dinkc_cmd.c src/audio.c src/fade.c src/save.c src/saybox.c src/font.c src/player.c src/hurt.c src/hard.c src/ini.c src/ff.c src/mapscr.c src/le.c src/fs.c src/residency.c
	$(HOSTCC) $(HOST_CFLAGS) -o $@ tests/test_dinkc_vm.c src/dinkc_vm.c src/dinkc_lex.c src/dinkc_var.c src/dinkc_cmd.c src/audio.c src/fade.c src/save.c src/saybox.c src/font.c src/player.c src/hurt.c src/hard.c src/ini.c src/ff.c src/mapscr.c src/le.c src/fs.c src/residency.c
	./$@

tests/test_dinkc_var: tests/test_dinkc_var.c src/dinkc_var.c src/dinkc_vm.c src/dinkc_lex.c src/dinkc_cmd.c src/audio.c src/fade.c src/save.c src/saybox.c src/font.c src/player.c src/hurt.c src/hard.c src/ini.c src/ff.c src/mapscr.c src/le.c src/fs.c src/residency.c
	$(HOSTCC) $(HOST_CFLAGS) -o $@ tests/test_dinkc_var.c src/dinkc_var.c src/dinkc_vm.c src/dinkc_lex.c src/dinkc_cmd.c src/audio.c src/fade.c src/save.c src/saybox.c src/font.c src/player.c src/hurt.c src/hard.c src/ini.c src/ff.c src/mapscr.c src/le.c src/fs.c src/residency.c
	./$@
...
tests/test_weapon: tests/test_weapon.c src/script.c src/dinkc_file.c src/dinkc_lex.c src/dinkc_parse.c src/dinkc_vm.c src/dinkc_var.c src/dinkc_cmd.c src/audio.c src/fade.c src/save.c src/saybox.c src/font.c src/player.c src/hurt.c src/hard.c src/pad.c src/ini.c src/ff.c src/mapscr.c src/world.c src/le.c src/fs.c src/residency.c src/brains.c
	$(HOSTCC) $(HOST_CFLAGS) -o $@ tests/test_weapon.c src/script.c src/dinkc_file.c src/dinkc_lex.c src/dinkc_parse.c src/dinkc_vm.c src/dinkc_var.c src/dinkc_cmd.c src/audio.c src/fade.c src/save.c src/saybox.c src/font.c src/player.c src/hurt.c src/hard.c src/pad.c src/ini.c src/ff.c src/mapscr.c src/world.c src/le.c src/fs.c src/residency.c src/brains.c
	DINK_DATA="$(DINK_DATA)" ./$@

tests/test_touch: tests/test_touch.c src/script.c src/dinkc_file.c src/dinkc_lex.c src/dinkc_parse.c src/dinkc_vm.c src/dinkc_var.c src/dinkc_cmd.c src/audio.c src/fade.c src/save.c src/saybox.c src/font.c src/player.c src/hurt.c src/hard.c src/pad.c src/ini.c src/ff.c src/mapscr.c src/world.c src/le.c src/fs.c src/residency.c src/brains.c src/hit.c src/edraw.c src/sprite.c src/bmp.c src/mem.c
	$(HOSTCC) $(HOST_CFLAGS) -o $@ tests/test_touch.c src/script.c src/dinkc_file.c src/dinkc_lex.c src/dinkc_parse.c src/dinkc_vm.c src/dinkc_var.c src/dinkc_cmd.c src/audio.c src/fade.c src/save.c src/saybox.c src/font.c src/player.c src/hurt.c src/hard.c src/pad.c src/ini.c src/ff.c src/mapscr.c src/world.c src/le.c src/fs.c src/residency.c src/brains.c src/hit.c src/edraw.c src/sprite.c src/bmp.c src/mem.c
	DINK_DATA="$(DINK_DATA)" ./$@

tests/test_inv: tests/test_inv.c src/inv.c src/script.c src/dinkc_file.c src/dinkc_lex.c src/dinkc_parse.c src/dinkc_vm.c src/dinkc_var.c src/dinkc_cmd.c src/audio.c src/fade.c src/save.c src/saybox.c src/font.c src/player.c src/hurt.c src/hard.c src/pad.c src/ini.c src/ff.c src/mapscr.c src/world.c src/le.c src/fs.c src/residency.c src/brains.c src/sprite.c src/bmp.c
	$(HOSTCC) $(HOST_CFLAGS) -o $@ tests/test_inv.c src/inv.c src/script.c src/dinkc_file.c src/dinkc_lex.c src/dinkc_parse.c src/dinkc_vm.c src/dinkc_var.c src/dinkc_cmd.c src/audio.c src/fade.c src/save.c src/saybox.c src/font.c src/player.c src/hurt.c src/hard.c src/pad.c src/ini.c src/ff.c src/mapscr.c src/world.c src/le.c src/fs.c src/residency.c src/brains.c src/sprite.c src/bmp.c
	DINK_DATA="$(DINK_DATA)" ./$@

tests/test_status: tests/test_status.c src/status.c src/inv.c src/script.c src/dinkc_file.c src/dinkc_lex.c src/dinkc_parse.c src/dinkc_vm.c src/dinkc_var.c src/dinkc_cmd.c src/audio.c src/fade.c src/save.c src/saybox.c src/font.c src/player.c src/hurt.c src/hard.c src/pad.c src/ini.c src/ff.c src/mapscr.c src/world.c src/le.c src/fs.c src/residency.c src/brains.c src/sprite.c src/bmp.c
...
tests/test_save: tests/test_save.c src/save.c src/dinkc_cmd.c src/audio.c src/fade.c src/dinkc_var.c src/dinkc_vm.c src/dinkc_lex.c src/saybox.c src/font.c src/player.c src/hurt.c src/hard.c src/ini.c src/ff.c src/mapscr.c src/le.c src/fs.c src/residency.c src/pad.c
	$(HOSTCC) $(HOST_CFLAGS) -o $@ tests/test_save.c src/save.c src/dinkc_cmd.c src/audio.c src/fade.c src/dinkc_var.c src/dinkc_vm.c src/dinkc_lex.c src/saybox.c src/font.c src/player.c src/hurt.c src/hard.c src/ini.c src/ff.c src/mapscr.c src/le.c src/fs.c src/residency.c src/pad.c
	./$@
...
build/wav_to_adpcm: tools/wav_to_adpcm.c src/le.c src/le.h
	mkdir -p build
...
tests/test_audio: tests/test_audio.c src/audio.c src/dinkc_cmd.c src/fade.c src/save.c src/dinkc_var.c src/dinkc_vm.c src/dinkc_lex.c src/saybox.c src/font.c src/player.c src/hurt.c src/hard.c src/ini.c src/ff.c src/mapscr.c src/le.c src/fs.c src/residency.c src/pad.c
...
clean:
	rm -rf build tests/test_boot_const tools/test_fs_join tests/test_bmp \
		...
		tests/test_save tests/test_startmenu tests/test_wav_to_adpcm tests/test_audio \
