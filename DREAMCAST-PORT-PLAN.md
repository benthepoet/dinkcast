...
**Where we are:** Tagged **v0.1.0** (2026-08-22). **V6** + **8.6 house** accepted. Audio **12 after 16**. **14.5** distill is on disc (#84–#86). **14.4c** pixels (#90). **14.3** leak check (#91). **15.3–15.4** weapons/magic (#92). **16.1** touch/pickup (#93). **16.2** inventory (#94). **16.3** HUD (#95). Playtest graft pickup/blood/barrel/pig-pen (#96). Occupancy graft (#97). Playtest stability (#98). **14.6** per-frame reads wait for full-campaign go. Next engine bite only when the requester says.
