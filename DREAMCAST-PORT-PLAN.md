...
- Screens: 14.4a seeds, one 4-neighbor ring, and warp interiors on those screens (old-man house is map **3**, not map 2). Do not flood 400–450. Keep the **used-frame set** (not 1..max): filling holes makes innwalls skip-no-save and 439+house Prev over the `file_blob` cap.
