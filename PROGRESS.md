...
| 16.2–16.3 | Inventory / HUD | pending | V6 |
...
| **Next picture (V6 inv/HUD)** | **~50%** | **16.1** source this PR (walk into sack). Next **16.2/16.3** Y grid + HUD |
...
| Weapons / magic / inventory | ~85% | 16.1 sack pickup; Y grid and HUD still 16.2/16.3 |
