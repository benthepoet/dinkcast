...
| 15.2 | Damage | source | `hurt_thing` + hit tag list; DIE/corpse; push 310; `dinfo` DIE; this PR |
...
| 2026-08-20 (15.2 source) | **~90%** | Fists `hurt_thing` / HIT / DIE / corpse / push / life 0 `dinfo`. Next **15.3** weapons. |
