...
| 2026-08-18 | **11.5** wave-1 commands; A runs `talk()` | this PR |
...
| 11.5 | Wave 1 commands | source | serial `say`; A = say/choice; no sprite `main()` attach |
| 11.6–11.9 | Attach…coverage | pending | |
