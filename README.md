...
- Releases: [CHANGELOG.md](CHANGELOG.md) (`VERSION` / git tag `v0.5.0`)
...
**v0.5.0** (2026-09-06). Per-frame `dir.ff` (**14.6**). AICA **12**. START + VMU **17**. Visual gates **V1–V6** and **8.6 house** stay accepted. Pictures: [docs/PLAYTEST.md](docs/PLAYTEST.md).
