...
`set_mode`, `reset_timer`, `set_dink_speed`, `load_sound`, `get_version`, `sp_noclip`, `sp_reverse`, `sp_sound`, `dink_can_walk_off_screen`, `compare_sprite_script`, `run_script_by_number`, …
