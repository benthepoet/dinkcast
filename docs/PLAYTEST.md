...
| Smashed barrel has no leftover hardness (409/441 seq 173) | `create_sprite` hard=1 (FreeDink add_sprite); not a seq-54 pin | `test_brains` created hard; `test_playtest` baked hard |
