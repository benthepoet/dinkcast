...
**Now:** V1–**V4** + **8.6 house** accepted. This PR: **11.7** choice lines + items prelude. Do not start 11.8 unless the requester says go. Next visual gate **V5**. Do not `@`-mention anyone.
