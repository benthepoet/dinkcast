...
**Now:** V1–**V4** + **8.6 house** accepted. **10.1** accepted. This PR: punch-idle PVR ghost (wait before evict). Do not start 10.3 unless the requester says go. Next visual gate **V5**. Do not `@`-mention anyone.
