...
**Now:** V1–**V4** + **8.6 house** accepted. This PR: preload unique sprite `.c` on enter (start house has no screen script). Do not start 11.1 unless the requester says go. Next visual gate **V5**. Do not `@`-mention anyone.
