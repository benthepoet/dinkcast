...
**Now:** V1–**V5** + **8.6 house** accepted. **14.3 leak check deferred**. **11.10** + screen-script **30240** + saybox follow + created sprite place + `font_colors` landed. **Warp `parm_seq`** (house door) in PR. Then **15.2**. Do not start 14.3 or 15.2 until the requester says go. Do not `@`-mention anyone.
