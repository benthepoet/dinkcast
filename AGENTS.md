...
**Now:** V1–**V4** + **8.6 house** accepted. **10.1** accepted. This PR: **11.0** DinkC file load. Do not start 11.1 unless the requester says go. Next visual gate **V5**. Do not `@`-mention anyone.
