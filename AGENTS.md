...
**Now:** V1–**V4** + **8.6 house** accepted. Next visual gate **V5 (13.2)**. Implementation order: **10 → 11 → 13 → 14 → 15 → 16 → 12 → 17**. Audio after inv/combat. Do not start 10.x unless the requester says go. Do not `@`-mention anyone.
