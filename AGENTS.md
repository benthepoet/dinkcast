...
**Now:** V1–**V4** + **8.6 house** accepted. **10.1** accepted. This PR: **10.2** hit probe. Do not start 10.3/11 unless the requester says go. Next visual gate **V5**. Do not `@`-mention anyone.
