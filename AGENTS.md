...
**Now:** V1–**V5** + **8.6 house** accepted. **14.3 leak check deferred**. **11.10** + screen-script **30240** + saybox follow + created sprite place + `font_colors` + warp `parm_seq` + talk/magic miss say + choice overlay + say hcenter landed. **15.2 Damage** in PR. Do not start 14.3 or 15.3 until the requester says go. Do not `@`-mention anyone.
