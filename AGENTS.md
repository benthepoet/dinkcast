...
**Now:** V1–**V4** + **8.6 house** accepted. This PR: **11.5** wave-1 DinkC commands + run `talk()`. Do not start 11.6 unless the requester says go. Next visual gate **V5**. Do not `@`-mention anyone.
