...
**Now:** V1–**V4** + **8.6 house** accepted. Next visual gate **V5 (13.2)**. Campaign systems: plan § **Official campaign systems**. Do not start 10.x unless the requester says go. Do not `@`-mention anyone.
