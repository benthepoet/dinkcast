...
**Now:** V1–**V5** + **8.6 house** accepted. This PR: leave-title PVR clear so splash does not stick. Do not start 14.3 unless the requester says go. Do not `@`-mention anyone.
