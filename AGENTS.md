...
**Now:** V1–**V5** + **8.6 house** accepted. This PR: keep hard.dat across swap (no second /cd fread). Do not start 14.3 unless the requester says go. Do not `@`-mention anyone.
