...
**Now:** V1–**V4 accepted**. This PR is `fix/editor-vision-filter` (intact house). Next visual gate is **V5 (13.2)**. Do not start 10.x unless the requester says go. Do not `@`-mention anyone.
