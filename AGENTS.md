...
**Now:** V1–**V4 accepted**. **8.6 house** seen in Flycast (`edraw unique 17`). Next visual gate **V5 (13.2)**. Do not start 10.x unless the requester says go. Do not `@`-mention anyone.
