...
**Now:** V1–**V4** + **8.6 house** accepted. This PR: **11.8** wave-3 DinkC (midi/status/combat stubs). Do not start 11.9 unless the requester says go. Next visual gate **V5**. Do not `@`-mention anyone.
