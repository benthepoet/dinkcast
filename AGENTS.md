...
**Now:** V1–**V4** + **8.6 house** accepted. This PR: **11.6** attach screen + sprite `main()`. Do not start 11.7 unless the requester says go. Next visual gate **V5**. Do not `@`-mention anyone.
