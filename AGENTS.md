...
**Now:** V1–**V5** + **8.6 house** accepted. This PR: restore sprites after edraw so mom/talk attach. Do not start 14.3 unless the requester says go. Do not `@`-mention anyone.
